...
func main() {
	...
	//创建创世块
	//createBlockchain("1DczFrcMNn7BWoy3YSCjsoG1SFRngyNLkE",nodeID)

	//币值转移
	/*send("1DczFrcMNn7BWoy3YSCjsoG1SFRngyNLkE","13HvmLXtWCMcifD5dz3Lik94KrdqBhqLd8",10,nodeID,true)
	send("1DczFrcMNn7BWoy3YSCjsoG1SFRngyNLkE","18vHK6mLjzQKJCvaLfbt7cwajprjPZnGR1",10,nodeID,true)*/
	...
	//获取钱包地址的帐户余额
	//getBalance("14aHAPWSShPYAiNEWM2nUrXRg6nePo85D1")
